// src/components/ConsultarVendas/index.js
...
export default function ConsultarVendas() {
    ...
    const navigate = useNavigate(); // Declara o hook de navegação
    ...
    const handleEditVenda = (venda) => {
        navigate('/cadastrarvendas', { state: { venda } }); // Passa o objeto venda via state
    };
